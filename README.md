...
- [Projeto Codificador e Descodificador de textos](#Codificablorr)
...
[Codificablorr](https://dablorr.github.io/ChallengeAlura/#)

### Resumo:

O projeto foi um desafio proposto pela Alura + Oracle através do Programa One - Oracle Next Education com o intuito de desafiar o desenvolvedor a colocar em prática os conceitos básicos do front-end adquiridos durante os cursos de HTML, CSS, JavaScript e lógica de programação oferecidos na plataforma de ensinos da Alura.
...
### Tópicos abordados durante o desafio:
    ...
    #### CSS3
        ...
        - Utilizar o @keyframes para efeitos de animação.
        - Utilizar o flexbox.
